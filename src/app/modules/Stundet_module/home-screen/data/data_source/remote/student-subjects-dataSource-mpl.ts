...
export class GetSubjectsImpl extends GetSubjects {
  constructor(private http: HttpClient) {
   ...
   getSubject(): Observable<SubjectEntity> {
    ...
    let data = this.http.get<SubjectEntity>('https://webgateway.selaheltelmeez.com/Curriculum/GetStudentSubjects', { headers: header });
    console.log(data)
    return data
  }
}
